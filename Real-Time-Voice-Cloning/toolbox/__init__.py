...
class Toolbox:
    ...
    def setup_events(self):
        ...
        #talk to me button 
        self.ui.talk_button.clicked.connect(self.javis)
    ...
    def javis(self):
        ...
        self.ui.text_prompt.appendPlainText( "Hello can i know your name")
        self.synthesize()
        self.vocode()
        ...
        self.ui.text_prompt.clear()
        self.ui.text_prompt.appendPlainText( "Hi " +data+ " how can i help you")
        self.synthesize()
        self.vocode()
        ...
        while 1:   
            ...
            if "how are you" in data:
                ...
                self.ui.text_prompt.clear()
                self.ui.text_prompt.appendPlainText("I am fine thank you!")
                self.synthesize()
                self.vocode()
            if "tell me a joke" in data:
                
                self.ui.text_prompt.clear()
                self.ui.text_prompt.appendPlainText("Did you hear about the guy who invented the knock knock joke he won the no bell prize")
                self.synthesize()
                self.vocode()
            ...
            if "what time is it" in data:
                ...
                self.ui.text_prompt.clear()
                self.ui.text_prompt.appendPlainText(ctime())
                self.synthesize()
                self.vocode()
